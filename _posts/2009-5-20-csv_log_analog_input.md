...
title: 'Log Analog Input to CSV File Demo'
type: 'System'
...
The below script demonstrates how to acquire analog data and save it to a CSV file that can be later opened and plotted in Excel.
This script demonstrates two different methods for analog data acquisition: read_analog_input() (for acquisition at <1Hz) and 
streaming methods (for >1 Hz acquisition).
